...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_5.setGeometry(QtCore.QRect(180, 250, 371, 16))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Ионизирующяя излучение:"))
        ...
        self.label_5.setText(_translate("Dialog", "Нахождение радиации в земле:"))
        ...
        self.label_8.setText(_translate("Dialog", "F - коэфицент пересечения \n"
                                                  "учитывая эффекты \n"
                                                  "фильтрации"))
