...
class Ui_Dozimetr(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(480, 529)
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 460, 501))
...
"border-radius: 7px;")
        ...
        self.inp_line_1.setGeometry(QtCore.QRect(20, 93, 420, 20))
...
"}")
        ...
        self.text_lab_1.setGeometry(QtCore.QRect(30, 53, 410, 21))
...
"border: none;")
        ...
        self.inp_line_2.setGeometry(QtCore.QRect(20, 173, 420, 20))
...
"}")
        ...
        self.inp_line_3.setGeometry(QtCore.QRect(20, 293, 420, 20))
...
"}")
        ...
        self.btn_give_otv.setGeometry(QtCore.QRect(220, 343, 220, 30))
...
"}")
        ...
        self.text_lab_3.setGeometry(QtCore.QRect(40, 213, 390, 60))
        self.text_lab_3.setStyleSheet("font: italic 12pt \"Arial\";\n"
"background-color: none;\n"
"border: none;")
        self.text_lab_3.setObjectName("text_lab_3")
        self.label_6 = QtWidgets.QLabel(self.widget)
        self.label_6.setGeometry(QtCore.QRect(10, 427, 61, 20))
...
"background-color: none;")
        ...
        self.trees_live_4.setGeometry(QtCore.QRect(70, 427, 160, 20))
...
"background-color: none;")
        ...
        self.text_calc.setGeometry(QtCore.QRect(180, 16, 90, 20))
...
"border: none;")
        ...
        self.lab_otv_1.setGeometry(QtCore.QRect(230, 430, 90, 20))
...
"background-color: none;")
        ...
        self.lab_otv_2.setGeometry(QtCore.QRect(330, 430, 50, 21))
...
"background-color: none;")
        ...
        self.img_png.setGeometry(QtCore.QRect(390, 420, 48, 41))
...
"background-color: none;")
        ...
        self.text_lab_2.setGeometry(QtCore.QRect(120, 143, 260, 21))
...
"border: none;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.text_lab_1.setText(_translate("Dialog", "Коэффициент калибровки, выраженный в рентгенах:"))
        self.btn_give_otv.setText(_translate("Dialog", "Получить ответ:"))
        self.text_lab_3.setText(_translate("Dialog", "Kоэффициент взвешенной дозы, учитывающий \n"
"различную проникающую способность различных \n"
"                               типов излучения:"))
        self.label_6.setText(_translate("Dialog", "Вывод:"))
        self.trees_live_4.setText(_translate("Dialog", "Радиация равняется:"))
        self.text_calc.setText(_translate("Dialog", "Дозиметр:"))
        self.text_lab_2.setText(_translate("Dialog", "Показания счетчика дозиметра:"))
    ...
    def calculate(self):
        k = float(self.inp_line_1.text())
        c = float(self.inp_line_2.text())
        w_r = float(self.inp_line_3.text())
